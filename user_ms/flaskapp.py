...
ride_ms = "ride_ms"   #for now its localhost 5000, on containers, this will be the bridged 172.something ip with the correct port number
user_ms = "user_ms"   #this things URL with the port number. change it properly later
